                ...
                <ul className="navbar-nav">
                    <li className="nav-item">
                        <Link className={`nav-link ${location.pathname === '/dashboard' ? 'active' : ''}`}
                            ...
                            <span className="nav-link-text ms-1">Tablesbleau de bord</span>
                        </Link>
                    </li>
                    <li className="nav-item">
                        <Link className={`nav-link ${location.pathname === '/employes' ? 'active' : ''}`}
                            to="/employes">
                            <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                <svg
                                    width="12px"
                            ...
                            <span className="nav-link-text ms-1">Gérer les employés</span>
                        </Link>
                    </li>
